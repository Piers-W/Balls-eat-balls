...
function PvPGame() {
  ...
  useEffect(() => {
    if (roomNumber) {
      myFirebase.recordPvPScore(roomNumber, player1Name, player2Name, player1Score, player2Score);
    }
    ...
    >
      {!isNameSubmitted ? (
        <div style={{ textAlign: 'center', maxWidth: '500px' }}>
          <h2>Enter Player Names and Room Number</h2>
          <p className="description-text">
            Fill in the player names. If the room number and player names are left blank, the game will be played in local mode and scores will not be uploaded. The room number should be a numeric value.
          </p>
          <input
        ...
        <>
          <ScoreBoard 
            ...
            player1Label={player1Name || "Player 1"} 
            player2Label={player2Name || "Player 2"} 
          />
